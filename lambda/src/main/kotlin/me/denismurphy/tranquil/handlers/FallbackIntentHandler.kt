...
class FallbackIntentHandler : RequestHandler {
    ...
    override fun handle(input: HandlerInput): Optional<Response> {
        val speechText = "<speak>\n" +
                "<prosody volume=\"x-loud\">Sorry can't do that yet, Tranquil can play the following genres</prosody>\n" +
                "<break time=\"1s\"/>\n" +
                "Celtic Music\n" +
                "<break time=\"200ms\"/>\n" +
                "Relaxing Sounds\n" +
        ...
        return input.responseBuilder
                ...
                .withSimpleCard("Tranquil", "The following genres are supported :\n" +
                        "•   Irish\n" +
                        "•   Celtic\n" +
                        "•   Calming\n" +
                        "•   Relaxing\n" +
